# Mick Charbonneau
# 1/10/2024
# heres my updated pychain challenge 18
# the picture proof of my work working can be found under images and my code can be found under starter code ive updated pychain.py
